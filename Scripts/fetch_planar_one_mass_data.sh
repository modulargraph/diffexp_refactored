...
destination=${PLANAR_ONE_MASS_DATA:-"$repo_root/Examples/OriginalDiffExp/Data/PlanarOneMass"}
base_url=https://arxiv.org/src/2005.04195v1/anc

mkdir -p "$destination"
scratch=$(mktemp -d "${TMPDIR:-/tmp}/diffexp2-planar-one-mass-data.XXXXXX")
