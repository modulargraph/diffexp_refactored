...
specForMaster[example_String, level_Integer, master_List, ftData_Association,
  ...
  {levelData, topo, levelParam, fixedRules, active, powers, activeProps,
   uf, U, F, fvars, n, L, v, dExpr, simplex, rescaled, params, jac, subRules,
  ...
  gammaArg = Expand[v - L*dExpr/2];
  uPow = Expand[v - (L + 1)*dExpr/2];
  fPow = Expand[-gammaArg];
...
topology = FTExampleTopology[example, "pysecdec"];
If[topology === $Failed, Exit[11]];
