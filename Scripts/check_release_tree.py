...
CPP_FILES = {
    ...
    "cpp/tests/test_adjoint_observable.cpp",
    "cpp/tests/test_immutable_recursive_cache.cpp",
...
EXAMPLE_FILES = {
    ...
    "Examples/FeynmanTrick/HennDoublePentagonBoundary.sh",
    "Examples/FeynmanTrick/HennDoublePentagonBoundary.wl",
    ...
    "Examples/FeynmanTrick/run_henn_boundary_manifest.py",
